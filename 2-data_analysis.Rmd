...
weight_consensus_reproducibility <- weight_consensus[reproducibility]/sum(weight_consensus[reproducibility]) # weighed criteria only for methods
...
### Temporal trend of total performance scores
...
### Comparison between performance and conclusiveness level
